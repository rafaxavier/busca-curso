  ...
  <!-- aqui termina o navbar -->
    ...
    <div class="container ">
        <div class="row container-form-add-curso ">
            ...
            <div class="form-add-curso">
                <h2>Altere os Campos :</h2>
                <form method="GET" action="../config_curso_adm.php">
                    <div class="input-group mb-3">
                        <input type="hidden" name="parametro2" value="NewNomeCurso">
                        <input type="hidden" name="cod-curso" value="<?php echo $dadosCurso['COD_curso'] ?>">
                        <input type="text" class="form-control"  required name="valor" placeholder="Insira o novo Nome do curso" aria-describedby="button-addon1">
                ...
                <form method="GET" action="../config_curso_adm.php">
                    <div class="input-group mb-3">
                        <input type="hidden" name="parametro2" value="NewDetalhes">
                        <input type="hidden" name="cod-curso" value="<?php echo $dadosCurso['COD_curso'] ?>">
                        <input type="text" class="form-control"  required name="valor" placeholder="Insira  novos Detalhes do curso" aria-describedby="button-addon1">
                        <div class="input-group-append">
                            <button class="btn btn-warning" type="submit" id="button-addon1">Aterar</button>
                        </div>
                    </div>
                ...
                <form method="GET" action="../config_curso_adm.php">
                    <div class="input-group mb-3">
                        <input type="hidden" name="parametro2" value="NewPreco">
                        <input type="hidden" name="cod-curso" value="<?php echo $dadosCurso['COD_curso'] ?>">
                        <input type="text" class="form-control"  required name="valor" placeholder="Insira  novo Preço do curso" aria-describedby="button-addon1">
                        <div class="input-group-append">
                            <button class="btn btn-warning" type="submit" id="button-addon1">Aterar</button>
                        </div>
                    </div>
                ...
                <form method="GET" action="../config_curso_adm.php">
                    <div class="input-group mb-3">
                        <input type="hidden" name="parametro2" value="NewLocalizacao">
                        <input type="hidden" name="cod-curso" value="<?php echo $dadosCurso['COD_curso'] ?>">
                        <input type="text" class="form-control"  required name="valor" placeholder="Insira  nova Localização do curso" aria-describedby="button-addon1">
                        <div class="input-group-append">
                            <button class="btn btn-warning" type="submit" id="button-addon1">Aterar</button>
                        </div>
                    </div>
                ...
                <!-- form que exclui o curso -->
                <form method="GET" action="../config_curso_adm.php">
                    <div class="input-group mb-3">
                        <input type="hidden" name="parametro2" value="excluir">
                        <input type="hidden" name="cod-curso" value="<?php echo $dadosCurso['COD_curso'] ?>">
                        <div class="input-group-append">
                            <button class="btn btn-danger" type="submit" id="button-addon1">Excluir</button>
                        </div>
                    </div>
                </form>
