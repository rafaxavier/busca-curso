...
if((!isset($_SESSION['login'])==true) and (!isset($_SESSION['senha'])==true) and (!isset($_SESSION['perm_acesso'])==true))
  {
	...
	$lista_cursos = mysqli_query($conn,"SELECT * FROM cursos INNER JOIN cursos_aderidos on cursos.COD_curso = cursos_aderidos.COD_curso where COD_usuario=$cod_usuario") or die("Erro");
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  ...
  <!-- aqui termina o navbar -->
    ...
    <?php while ($aux = mysqli_fetch_assoc($lista_cursos)){ ?>
     ...
     <a href="perfil_meus_cursos.php/?parametro=<?php echo $aux['COD_curso']?> ">
